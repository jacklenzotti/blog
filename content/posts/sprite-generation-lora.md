...
Here are a few examples from the training set — these are my actual hand-drawn originals:
...
Here's the training progression — base model on the left, LoRA output on the right. Watch the style converge:

![Step 100 — early training, style barely present](/blog/sprite-generation-lora/first_lora_step_100.png)
![Step 700 — starting to pick up the linework](/blog/sprite-generation-lora/first_lora_step_700.png)
![Step 1200 — style locked in, wobbly lines and all](/blog/sprite-generation-lora/first_lora_step_1200.png)

And the first raw output from the LoRA — the moment it clicked:

![First LoRA output — crude but unmistakably in the right style](/blog/sprite-generation-lora/first_lora_output.png)
...
Here are some of the final game-ready sprites — all generated by the pipeline, none of these subjects were in the training data:
